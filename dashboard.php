...
<div class="flex-bagian1">
    <div class="window-dashboard1">
        <canvas id="penjualan-harian">
        </canvas>
    </div>
    <div class="window-dashboard2">
        <canvas id="pengeluaran-harian">
        </canvas>
    </div>
</div>
<div class="flex-bagian2">
    <div class="window-dashboard3">
        <canvas id="perbandingan">

        </canvas>
    </div>
    <div class="window-dashboard4">
        <h2>Penjualan Hari Ini</h2>
        <h1>1.000.000</h1>
    </div>
    <div class="window-dashboard5">
        <h2>Laba Bruto Hari ini</h2>
        <h1>100.000</h1>
    </div>
    <div class="window-dashboard6">
